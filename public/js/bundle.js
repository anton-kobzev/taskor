...
__webpack_require__(/*! ./components/App */ "./source/static/js/components/App.js");
__webpack_require__(/*! https://use.fontawesome.com/releases/v5.0.8/js/all.js */ "https://use.fontawesome.com/releases/v5.0.8/js/all.js");

/***/ }),

/***/ "./source/static/js/components/AddTask.js":
/*!************************************************!*\
  !*** ./source/static/js/components/AddTask.js ***!
  \************************************************/
/*! no static exports found */
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { className: 'btn btn-link add-task-button', onClick: function onClick() {
                            ...
                            document.addEventListener('mouseup', function (e) {
                                if (!e.target.classList.contains('add-task-name-input') && !e.target.classList.contains('add-task-submit-button')) {
                                    document.querySelector('.add-task-button').style.display = 'block';
                                    document.querySelector('.add-task-form').style.display = 'none';
                                }
                            });
                        } },
                    _react2.default.createElement('i', { className: 'fas fa-plus mr-1' }),
                    'Add new task'
                ),
                _react2.default.createElement(
                    'form',
                    { onSubmit: this.handleSubmit, className: 'form-inline justify-content-start add-task-form mt-2',
                        style: { display: 'none' } },
                    _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement('input', { type: 'text', onChange: function onChange(e) {
                            ...
                            placeholder: 'Task name', value: this.state.newTask.name, required: true })
                    ),
                    _react2.default.createElement('input', { type: 'submit', className: 'btn btn-primary add-task-submit-button', value: 'Add' })
                )
            );
        }
    }]);
...
/***/ "./source/static/js/components/App.js":
/*!********************************************!*\
  !*** ./source/static/js/components/App.js ***!
  \********************************************/
/*! no static exports found */
...
var _NavBar = __webpack_require__(/*! ./NavBar */ "./source/static/js/components/NavBar.js");

var _NavBar2 = _interopRequireDefault(_NavBar);

var _TasksList = __webpack_require__(/*! ./TasksList */ "./source/static/js/components/TasksList.js");
...
/***/ "./source/static/js/components/EditTask.js":
/*!*************************************************!*\
  !*** ./source/static/js/components/EditTask.js ***!
  \*************************************************/
/*! no static exports found */
...
var EditTask = function (_Component) {
    ...
    _createClass(EditTask, [{
        key: 'handleInput',
        value: function handleInput(key, e) {
            var state = Object.assign({}, this.state.task);
            state[key] = e.target.value;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'd-flex w-100 justify-content-between task-edit-inner' },
                        _react2.default.createElement('input', { type: 'text', onChange: function onChange(e) {
                                return _this2.handleInput('name', e);
                            }, tabIndex: '1',
                            className: 'form-control mb-2 task-name-input', placeholder: 'Task name', required: true,
                            value: this.state.task.name }),
                        _react2.default.createElement(
                            'div',
                            { className: 'task-actions d-flex align-items-center' },
                            _react2.default.createElement(
                                'a',
                                { href: 'javascript:', title: 'Delete', className: 'action action-icon', onClick: function onClick() {
                                        _this2.props.onDelete(_this2.state.task);
                                    } },
                                _react2.default.createElement('i', { className: 'fas fa-trash' })
                            ),
                            _react2.default.createElement(
                                'a',
                                { href: 'javascript:', title: 'Start timer', className: 'action action-icon' },
                                _react2.default.createElement('i', { className: 'far fa-clock' })
                            ),
                            _react2.default.createElement('input', { type: 'submit', className: 'btn btn-primary action action-button',
                                value: 'Done' })
                        )
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'd-flex w-100 justify-content-between task-edit-inner' },
                        _react2.default.createElement('textarea', { className: 'form-control task-description-input', rows: '3', tabIndex: '2',
...
/***/ "./source/static/js/components/NavBar.js":
/*!***********************************************!*\
  !*** ./source/static/js/components/NavBar.js ***!
  \***********************************************/
/*! no static exports found */
...
var NavBar = function (_Component) {
    ...
    _createClass(NavBar, [{
        ...
        value: function checkMail() {
            ...
            fetch('/api/mail/unreadCountByFolders').then(function (response) {
                return response.json();
            }).then(function (data) {
                var mailInfo = [];
                for (var mailLabel in data) {
...
/***/ "./source/static/js/components/Task.js":
/*!*********************************************!*\
  !*** ./source/static/js/components/Task.js ***!
  \*********************************************/
/*! no static exports found */
...
var _EditTask = __webpack_require__(/*! ./EditTask */ "./source/static/js/components/EditTask.js");
...
var Task = function (_Component) {
    ...
    function Task(props) {
        ...
        _this.handleEditTaskClick = _this.handleEditTaskClick.bind(_this);
        _this.handleDeleteTask = _this.handleDeleteTask.bind(_this);
        _this.handleDoneTask = _this.handleDoneTask.bind(_this);
        _this.handleNotDoneTask = _this.handleNotDoneTask.bind(_this);
        _this.handleArchiveTask = _this.handleArchiveTask.bind(_this);
        return _this;
    }
    ...
    _createClass(Task, [{
        ...
        key: 'handleEditTaskClick',
        value: function handleEditTaskClick(e) {
            if (e.target.classList.contains('task-inner') || e.target.classList.contains('task-name') || e.target.classList.contains('task-description')) {
                var _iteratorNormalCompletion = true;
                var _didIteratorError = false;
                var _iteratorError = undefined;

                try {
                    for (var _iterator = document.getElementsByClassName('task')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        var _e = _step.value;

                        _e.classList.remove('active-task');
                    }
                } catch (err) {
                    _didIteratorError = true;
                    _iteratorError = err;
        ...
        key: 'handleDoneTask',
        value: function handleDoneTask() {
            this.props.onDone(this.props.task);
        }
    }, {
        key: 'handleNotDoneTask',
        value: function handleNotDoneTask() {
            this.props.onNotDone(this.props.task);
        }
    }, {
        key: 'handleArchiveTask',
        value: function handleArchiveTask() {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: "list-group-item flex-column align-items-start task" + (task.done ? " task-done" : ""),
                    id: 'task-' + task.id },
                _react2.default.createElement(
                    'div',
                    { className: 'task-actions task-actions-prepend' },
                    task.done ? _react2.default.createElement(
                        'a',
                        { href: 'javascript:', title: 'Not done', className: 'action action-icon',
                            key: "task-done-" + task.id,
                            onClick: this.handleNotDoneTask },
                        _react2.default.createElement('i', { className: 'far fa-check-circle' })
                    ) : _react2.default.createElement(
                        'a',
                        { href: 'javascript:', title: 'Done!', className: 'action action-icon',
                            onClick: this.handleDoneTask },
                        _react2.default.createElement('i', { className: 'far fa-circle' })
                    )
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'task-view', onClick: this.handleEditTaskClick },
                    _react2.default.createElement(
                        'div',
                        { className: 'd-flex w-100 justify-content-between task-inner' },
                        _react2.default.createElement(
                            'span',
                            { className: 'task-name' },
                            task.name
                        ...
                        _react2.default.createElement(
                            ...
                            task.done === 1 && _react2.default.createElement(
                                'a',
                                { href: 'javascript:', title: 'Archive', className: 'action action-icon',
                                    key: "task-" + task.id + "-archive",
                                    onClick: this.handleArchiveTask },
                                _react2.default.createElement('i', { className: 'fas fa-archive' })
                            ),
                            _react2.default.createElement(
                                'a',
                                { href: 'javascript:', title: 'Delete', className: 'action action-icon',
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'd-flex w-100 justify-content-between task-inner' },
                        _react2.default.createElement('p', { className: 'task-description', dangerouslySetInnerHTML: {
                                __html: Task.renderDescription(task.description)
                            } }),
                        _react2.default.createElement(
                            'span',
                            { className: 'task-created-datetime' },
                            Task.renderDateTime(task.created_at)
                        )
                    )
                ),
                _react2.default.createElement(_EditTask2.default, { task: task, onEdit: this.handleEditTask, onDelete: this.handleDeleteTask }),
                _react2.default.createElement(
                    _reactModal2.default,
                    { isOpen: this.state.showDeleteConfirmModal, ariaHideApp: false },
                    _react2.default.createElement(
                        'div',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            { className: 'btn btn-danger', onClick: function onClick() {
                                    return _this2.props.onDelete(task);
                                }, autoFocus: true },
                            'Yes'
                        ),
                        _react2.default.createElement(
                            ...
                            { className: 'btn btn-secondary ml-1',
                                onClick: function onClick() {
                                    return _this2.setState({ showDeleteConfirmModal: false });
                                } },
                            'No'
                        )
                    ),
        ...
        key: 'renderDateTime',
        value: function renderDateTime(datetime) {
            var date = new Date(Date.parse(datetime)),
                now = new Date(),
                diffMinutes = Math.round((now - date) / 1000 / 60);
            if (diffMinutes < 1) return 'just now';else if (diffMinutes === 1) return '1 minute ago';else if (diffMinutes < 60) return diffMinutes + ' minutes ago';else if (diffMinutes > 59 && diffMinutes < 60 * 24) return Math.round(diffMinutes / 60) + ' hour ago';else if (diffMinutes < 60 * 24) return Math.round(diffMinutes / 60) + ' hours ago';else return (date.getDate() < 10 ? '0' + date.getDate() : date.getDate()) + '.' + (date.getMonth() < 10 ? '0' + date.getMonth() : date.getMonth()) + '.' + date.getFullYear() + ' ' + (date.getHours() < 10 ? '0' + date.getHours() : date.getHours()) + ':' + (date.getMinutes() < 10 ? '0' + date.getMinutes() : date.getMinutes());
        }
    }, {
        key: 'renderDescription',
        value: function renderDescription(desc) {
            if (desc) {
                // Search for links
                var matches = linkify.match(desc);
...
/***/ "./source/static/js/components/TasksList.js":
/*!**************************************************!*\
  !*** ./source/static/js/components/TasksList.js ***!
  \**************************************************/
/*! no static exports found */
...
var _Task = __webpack_require__(/*! ./Task */ "./source/static/js/components/Task.js");

var _Task2 = _interopRequireDefault(_Task);

var _AddTask = __webpack_require__(/*! ./AddTask */ "./source/static/js/components/AddTask.js");
...
var TasksList = function (_Component) {
    ...
    _createClass(TasksList, [{
        ...
        key: 'handleDoneTask',
        value: function handleDoneTask(task) {
            task.done = 1;
            this.updateTask(task);
            this.updateTaskInList(task);
        }
        ...
        key: 'handleNotDoneTask',
        value: function handleNotDoneTask(task) {
            task.done = 0;
            this.updateTask(task);
            this.updateTaskInList(task);
        }
        ...
        key: 'handleArchiveTask',
        value: function handleArchiveTask(task) {
            task.archive = 1;
            this.updateTask(task);
            this.removeTaskFromList(task);
        }
        ...
        value: function renderTasks() {
            ...
            if (this.state.loaded) {
                if (this.state.error) {
                    ...
                    content = this.state.tasks.map(function (task) {
                        return _react2.default.createElement(_Task2.default, { task: task, key: task.id, onEdit: _this4.handleEditTask, onDelete: _this4.handleDeleteTask,
                            onDone: _this4.handleDoneTask, onNotDone: _this4.handleNotDoneTask,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'col' },
                            _react2.default.createElement(_AddTask2.default, { onAdd: this.handleAddTask })
                        )
                    )
                )
            );
...
/***/ 0:
/*!**********************************************************************!*\
  !*** multi ./source/static/js/app.js ./source/static/css/style.sass ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./source/static/js/app.js */"./source/static/js/app.js");
module.exports = __webpack_require__(/*! ./source/static/css/style.sass */"./source/static/css/style.sass");
